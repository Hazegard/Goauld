...
type VsCode struct {
	Target     string `arg:"" name:"agent" yaml:"agent" help:"Target agent to open in VS Code remote mode."`
	RemotePath string `arg:"" yaml:"remote-path" default:"." help:"Remote path to open in VS Code (default: current directory)."`
}
