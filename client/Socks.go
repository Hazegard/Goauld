...
type Socks struct {
	Target         string   `arg:"" name:"agent" yaml:"agent" help:"Target agent to connect to."`
	...
	SSHArgs        []string `arg:"" yaml:"ssh-args" passthrough:"" optional:"" help:"Additional arguments passed directly to the SSH command."`
}
